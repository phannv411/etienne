...
$(document).ready(function(){
    ...
    $(".x-mark").click(function(){
      $("#signup-popup").fadeOut(600,'swing');
      $("#signin-popup").fadeOut(600,'swing');
      $("#blackscreen3").fadeOut(300,'swing');
      $("#blackscreen2").fadeOut(300,'swing');
    })
  })
...
$(document).ready(function(){
    ...
    $("#signin-modal-mb").click(function(){
      $("#megamenu-content-mb").fadeOut(200, 'swing');
      $("#signin-mb").fadeIn(700, 'swing');
      $("#signup-mb").fadeOut(400, 'swing');
    })


    $(".return-mark-mb").click(function(){
      $("#signup-mb").fadeOut(300, 'swing');
      $("#signin-mb").fadeOut(300, 'swing');
      $("#megamenu-content-mb").fadeIn(300, 'swing');
    })

    $("#signup-btn-mb").click(function(){
      $("#signin-mb").fadeOut(200, 'swing');
      $("#signup-mb").fadeIn(700, 'swing');
    })
