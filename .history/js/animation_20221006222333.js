...
ScrollTrigger.matchMedia({
    ...
    "(min-width: 992px)": function() {
        ...
        tlftProduct.from(".product-ft-list .cardproduct",{
            duration: 6,
            x: -100,
            ease: "sine.out(2)",
            opacity: 0,
        ...
        tlftProduct.from(".btn-fluid-secondary",{
            duration: 3,
            y: -50,
            ease: "sine.out(2)",
            opacity: 0,
  ...
  // Tablet--------------------------------------------
    ...
    "(max-width: 767px)": function() {
        ...
        tlFtBlogTB.from(".blog-ft-header-mb", {
            duration: 0.5, 
            y: 50,
            ease: "sine.out(1)",
            opacity: 0,
        ...
        tlFtBlogTB.from(".blog-ft-content-mb", {
            duration: 0.5, 
            y:50,
            stagger: 2,
            ease: "sine.out(1)",
        ...
        tlFtBlogTB.from(".blog-ft-content-mb a", {
            duration: 0.5, 
            scale: 0.5,
            ease: "sine.out(1)",
            opacity: 0,
