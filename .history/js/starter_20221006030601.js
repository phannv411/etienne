...
//     var $nav = $(".header-desktop");
//     var $banner = $(".sectionBanner");
//     $nav.toggleClass('nav-scrolled-yellow', $(this).scrollTop() > $banner.height());
//   });
// });



var top1 = $('.sectionGreen').offset().top;
var top2 = $('.sectionYellow').offset().top;
var $nav = $(".header-desktop");

$(function () {
  $(document).scroll(function () {
    var scrollNav = $(document).scrollTop();
    if (scrollNav) >= top1 && scrollNav < top2 {
      $nav.addClass('nav-scrolled-green');
      $nav.removeClass('nav-scrolled-yellow');
    }
  });
});
