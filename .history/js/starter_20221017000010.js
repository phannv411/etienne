...
document.querySelector('#twomb').value=upperSlidermb.value;
document.querySelector('#onemb').value=lowerSlidermb.value;
var  lowerValmb = parseInt(lowerSlidermb.value);
var upperValmb = parseInt(upperSlidermb.value);

upperSlidermb.oninput = function () {
  lowerValmb = parseInt(lowerSlidermb.value);
  upperValmb = parseInt(upperSlidermb.value);
  
  if (upperValmb < lowerValmb + 4) {
    lowerSlidermb.value = upperValmb - 4;
    if (lowerValmb == lowerSlidermb.min) {
      upperSlidermb.value = 4;
    }
  }
  document.querySelector('#twomb').value=this.value
};

lowerSlidermb.oninput = function () {
  lowerValmb = parseInt(lowerSlidermb.value);
  upperValmb = parseInt(upperSlidermb.value);
  if (lowerValmb > upperValmb - 4) {
    upperSlidermb.value = lowerValmb + 4;
    if (upperValmb == upperSlidermb.max) {
      lowerSlidermb.value = parseInt(upperSlidermb.max) - 4;
    }
  }
  document.querySelector('#onemb').value=this.value
};
